...
var charsTween:FlxTween;

function postCreate()
    camera.followLerp = 0.08;
function create(){

    importScript("data/scripts/preloadStagesImages/" + curStage);
    ...
    if (!lowMem){
        ...
        tweenLoopAngle(platform, -0.8, 0.8, 2.5, 2.5);
        ...
        tweenLoopAngle(rock4, -10, -20, 15, 15);
        ...
        pussy = FlxTween.tween(rock4, {y: rock4.y+50}, 2.5, {ease: FlxEase.sineInOut, type: FlxTween.PINGPONG});
    }
    ...
    /*for(i in [dad, gf, boyfriend]) {
       charsTween = FlxTween.tween(i, {y: i.y-50}, 2.5, {ease: FlxEase.sineInOut, type: FlxTween.PINGPONG});
    }*/
}
